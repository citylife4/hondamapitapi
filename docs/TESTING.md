...
3. Expected output:
   ```
   [HH:MM:SS YYYY-MM-DD] INFO - Connecting to Oracle Database...
   [HH:MM:SS YYYY-MM-DD] INFO - Adding column battery...
   ✓ Column battery added successfully
   [HH:MM:SS YYYY-MM-DD] INFO - Adding column hdop...
   ✓ Column hdop added successfully
   [HH:MM:SS YYYY-MM-DD] INFO - Adding column odometer...
   ✓ Column odometer added successfully
   [HH:MM:SS YYYY-MM-DD] INFO - Adding column last_coord_ts...
   ✓ Column last_coord_ts added successfully
   [HH:MM:SS YYYY-MM-DD] INFO - Migration completed successfully!
   ```
